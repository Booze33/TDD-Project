...
**TDD Project** In this project we implement a class with some methods, but do it by doing test-driven development (TDD). Idea is to write tests first and then the code.
...
```sh
  cd my-folder
  git clone https://github.com/Booze33/TDD-Project.git
```
